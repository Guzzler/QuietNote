# Snapshot: docs/initiatives/README.md — 2026-08-16 (pre-prune)

Frozen verbatim by the planner on 2026-08-16, immediately before the amendment log (2026-08-08 through 2026-08-16) was distilled into a standing-rules block in the live file. **History, not a source of truth** — see [README.md](README.md).
